...
const MainContainer = () => {
    ...
    const [openDropdown, setOpenDropdown] = useState<"status" | "department" | "category" | null>(null);
    ...
    const renderDropdown = (type: "status" | "department" | "category", options: string[], value: string, setter: (val: string) => void) => (
